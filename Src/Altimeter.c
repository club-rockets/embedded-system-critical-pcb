...
void Apogee_Detection(Altimeter_t* temp_altimeter)
{
    ...
    temp_altimeter->Apogee_Estimation = temp_altimeter->Filtered_Altitude
        + (temp_altimeter->Filtered_Velocity) * (temp_altimeter->Filtered_Velocity) * 1.5 / temp_altimeter->Filtered_Acceleration;
    ...
    if (temp_altimeter->Filtered_Altitude - temp_altimeter->Apogee_Estimation < 500) {
