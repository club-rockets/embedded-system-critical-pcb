...
const arm_matrix_instance_f32 H_t_f32 = {
    .numCols = 1,
    .numRows = 3,
    .pData = H_t,
};
...
float32_t A[9] = { 1, KALMAN_TIME_STEP, KALMAN_TIME_STEP* KALMAN_TIME_STEP * 0.5, 0, 1, KALMAN_TIME_STEP, 0, 0, 1 };

arm_matrix_instance_f32 A_f32 = {
    .numCols = 3,
    .numRows = 3,
    .pData = A,
};
...
arm_matrix_instance_f32 A_t_f32 = {
    .numCols = 3,
    .numRows = 3,
    .pData = A_t,
};
...
arm_matrix_instance_f32 P0_f32 = {
    .numCols = 3,
    .numRows = 3,
    .pData = P0,
};
...
arm_matrix_instance_f32 P1_f32 = {
    .numCols = 3,
    .numRows = 3,
    .pData = P1,
};

float32_t P_past[9] = { VAR_MODEL_S, 0, 0, 0, VAR_MODEL_V, 0, 0, 0, VAR_MODEL_A };
arm_matrix_instance_f32 P_past_f32 = {
    .numCols = 3,
    .numRows = 3,
    .pData = P_past,
};
...
arm_matrix_instance_f32 K_last_f32 = {
    .numCols = 1,
    .numRows = 3,
    .pData = K_last,
};
...
//state matrix
float32_t X0[3] = { 0.1 };
arm_matrix_instance_f32 X0_f32 = {
    .numCols = 1,
    .numRows = 3,
    .pData = X0,
};
...
float32_t X1[3] = { 0.1 };
arm_matrix_instance_f32 X1_f32 = {
    .numCols = 1,
    .numRows = 3,
    .pData = X1,
};
...
arm_matrix_instance_f32 X_past_f32 = {
    .numCols = 1,
    .numRows = 3,
    .pData = X_past,
};
...
*/
    ...
    arm_matrix_instance_f32 temp1_3x1_f32 = {
        .numCols = 1,
        .numRows = 3,
        .pData = temp1_3x1,
    };
    ...
    arm_matrix_instance_f32 temp1_3x3_f32 = {
        .numCols = 3,
        .numRows = 3,
        .pData = temp1_3x3,
    };
    ...
    arm_matrix_instance_f32 temp2_3x3_f32 = {
        .numCols = 3,
        .numRows = 3,
        .pData = temp2_3x3,
    };
...
*/
    ...
    arm_matrix_instance_f32 temp1_1x3_f32 = {
        .numCols = 3,
        .numRows = 1,
        .pData = temp1_1x3,
    };
    ...
    arm_matrix_instance_f32 temp1_1x1_f32 = {
        .numCols = 1,
        .numRows = 1,
        .pData = temp1_1x1,
    };
    ...
    arm_matrix_instance_f32 temp2_1x1_f32 = {
        .numCols = 1,
        .numRows = 1,
        .pData = temp2_1x1,
    };
    ...
    } while (temp_kalman->Filter_Converge == 0 && loop_counter < CONVERGENCE_TIMEOUT);
